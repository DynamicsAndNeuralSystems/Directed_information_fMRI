...
# Define data directory and read in brain region lookup data
data_dir = "data/numpy_files/"
...
# Save to a CSV file for downstream analysis
HCP100_DI.to_csv("HCP100_Directed_Information.csv", index = False)